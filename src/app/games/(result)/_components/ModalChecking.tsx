...
const ModalChecking = () => {
  ...
  return (
    <div className='bg-[#BFA5ED] w-[1008px] h-[768px] rounded-[3.125rem] flex flex-col items-center'>
      <h2 className='mt-12 title-40 text-[#4f21a6]'>오답공개</h2>
        ...
        <ul className='mt-12 w-[836px] max-h-[559px] overflow-auto'>
          {result.map((result, index) => (
            ...
            >
              ...
              {openResult === index && (
                <div className=' p-4 mb-[18px] rounded-lg bg-[#DDD0F6] '>

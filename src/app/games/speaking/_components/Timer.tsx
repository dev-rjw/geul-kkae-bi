...
const Timer = ({ handleUpsertScore, data, finalPercent }: Upsert) => {
  ...
  return (
    <div className='w-[100%]'>
      <div className='w-full bg-[#fdeace] h-[28px] dark:bg-gray-700 max-md:h-[14px]'>
        <div
          className='bg-[#f9bc5f] h-[28px] rounded-r-[10px] transition-all ease-linear max-md:h-[14px] max-md:relative'

            ...
            <FormItem>
              ...
              <ScrollArea className='h-[10rem] w-full rounded-lg py-5 px-6 bg-[#F2F2F2]'>
                <div className='caption-14 text-gray-400'>
                  제1장 총칙
                  <br />
                  제1조 (목적)이 약관은 글깨비 (이하 &quot;회사&quot;)가 온라인으로 제공하는 국어 문해력 테스트 및 이에
                  부수된 제반 서비스(이하 &quot;테스트 서비스&quot;)의 이용과 관련하여 회사와 회원 간의 권리, 의무 및
                  ...
                  <br />
                  &quot;테스트 서비스&quot;라 함은 회사가 회원에게 온라인으로 제공하는 국어 문해력 테스트 및 이에 부수된
                  제반 서비스를 의미합니다.
                  <br />
                  ...
                  절차를 의미합니다.
                  <br />
                  &quot;마이 페이지&quot;라 함은 회원이 자신의 프로필을 설정하고 정보를 수정할 수 있는 개인화된 페이지를
                  의미합니다.
                  <br />
                  ...
                  있습니다.
                  <br />
                  회원가입을 희망하는 자는 본 약관에 동의하고 회사가 요구하는 정보(이메일 주소, 비밀번호 등)를 제공해야
                  합니다.
                  <br />
                  제2조 (테스트 서비스 이용)
                  <br />
